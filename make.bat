...
g++ -std=c++11 -I.\include -c -fPIC -o objects\Texture.o sources\Texture.cc
g++ -std=c++11 -I.\include\vendor -c -fPIC -o objects\stb_image.o sources\vendor\stb_image.cc
g++ -std=c++11 -I.\include -shared -o libRenderer.dll objects\Renderer.o objects\VertexArray.o objects\VertexBuffer.o objects\IndexBuffer.o objects\Shader.o objects\VertexBufferLayout.o objects\Texture.o objects\stb_image.o .\glew32.dll .\glfw3.dll -I.\include -lopengl32
