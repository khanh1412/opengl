...
g++ -std=c++11 -c -fPIC -o objects\VertexBufferLayout.o sources\VertexBufferLayout.cc .\glew32.dll .\glfw3.dll -I.\include -lopengl32
...
g++ -std=c++11 -o libRenderer.dll objects\Renderer.o objects\VertexArray.o objects\VertexBuffer.o objects\VertexBufferLayout.o objects\IndexBuffer.o objects\Shader.o .\glew32.dll .\glfw3.dll -I.\include -lopengl32
